...
int main()
{
	...
	int* ptr = getDouble(&x);
	cout << *ptr << endl;
	// notic that if we call printName fnction after cout<<*ptr the result wil be 10 else will be another 
	// that is happen because of call stack order the getdoble function is popped from stack and  its local varibles 
